...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        onClick={handleWhatsAppClick}
        className="group bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3 hover:pr-6"
        style={{
      ...
      <div
        className="absolute top-0 left-0 w-16 h-16 rounded-full animate-pulse opacity-20 -z-10"
        style={{
